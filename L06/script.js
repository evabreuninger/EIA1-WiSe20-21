...
var Afrika08 = 1028;
var Afrika18 = 1235.5;
var Asien08 = 12954.72;
var Asien18 = 16274.1;
var Australien08 = 1993;
var Australien18 = 2100.5;
var EmissionG18 = Afrika18 + SAmerika18 + Europa18 + NAmerika18 + Asien18 + Australien18;
//Europa
function europa() {
    ...
    document.querySelector("#growth").innerHTML = -Math.round((1 - Europa18 / Europa08) * 100) + "% changed";
...
function namerika() {
    ...
    document.querySelector("#growth").innerHTML = -Math.round((1 - NAmerika18 / NAmerika08) * 100) + "% changed";
...
function samerika() {
    ...
    document.querySelector("#growth").innerHTML = -Math.round((1 - SAmerika18 / SAmerika08) * 100) + "% changed";
...
function afrika() {
    ...
    document.querySelector("#growth").innerHTML = -Math.round((1 - Afrika18 / Afrika08) * 100) + "% changed";
...
function asien() {
    ...
    document.querySelector("#growth").innerHTML = -Math.round((1 - Asien18 / Asien08) * 100) + "% changed";
...
function australien() {
    ...
    document.querySelector("#growth").innerHTML = -Math.round((1 - Australien18 / Australien08) * 100) + "% changed";
